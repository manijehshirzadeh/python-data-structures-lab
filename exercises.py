...
def hometown_info():
    ...
    home_town_message = 'I was born in {city}, {state} - population of {population}'
    return home_town_message.format(city = home_town['city'], state = home_town['state'], population = home_town['population'])
...
def list_home_town_items():
    ...
    home_town_items = []
    for x in home_town:
        home_town_items.append(x + " = " + home_town[x])
